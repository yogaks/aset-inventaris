...
<!--END MODAL EDIT WORK ORDER-->
                  ...
                  <div class="modal fade" id="asetUpdate<?php echo $data->as_id ?>" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
									<form class="form-horizontal form-label-left" method="post" action="<?= site_url('aset/updateAset') ?>" >

										<div class="form-group row ">
											<label class="control-label col-md-3 col-sm-3 ">Nama</label>
											<div class="col-md-9 col-sm-9 ">
												<input type="hidden" name="as_id" value="<?php echo $data->as_id ?>" >
												<input type="text" name="as_nama" class="form-control" value="<?php echo $data->as_nama ?>" required >
											</div>
										</div>
										<div class="form-group row">
											<label class="control-label col-md-3 col-sm-3 ">Jenis</label>
											<div class="col-md-9 col-sm-9 ">
												<input type="text" name="as_jenis" class="form-control" value="<?php echo $data->as_jenis ?>" required >
											</div>
										</div>
										<div class="form-group row">
											<label class="control-label col-md-3 col-sm-3 ">Kode</label>
											<div class="col-md-9 col-sm-9 ">
												<input type="text" name="as_kode" class="form-control" value="<?php echo $data->as_kode ?>" readonly >
											</div>
										</div>
										<div class="form-group row">
											<label class="control-label col-md-3 col-sm-3 ">Jumlah</span>
											...
											<div class="col-md-9 col-sm-9 ">
												<input type="numeric" name="as_jml" class="form-control" value="<?php echo $data->as_jml ?>" required >
											</div>
										</div>
										<div class="form-group row">
											<label class="control-label col-md-3 col-sm-3 ">Satuan</label>
											<div class="col-md-9 col-sm-9 ">
												<input type="text" name="as_sat" class="form-control" value="<?php echo $data->as_sat ?>" >
											</div>
										</div>
